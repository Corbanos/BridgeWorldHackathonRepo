...
public class PlayerController : MonoBehaviour {
    ...
    void Update() {
        ...
        audioWind.pitch = Mathf.Clamp(Mathf.Abs(rb.linearVelocity.y * windPitchMultiplier), 0f, 2f) + Random.Range(-.1f, .1f);
    ...
    void LateUpdate() {
        ...
        // Fall Effect
        if (!isGrounded && Mathf.Abs(rb.linearVelocity.y) >= cameraShakeThreshold) {
